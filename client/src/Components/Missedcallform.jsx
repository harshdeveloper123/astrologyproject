...
function Missedcallform() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    console.log('Missed Call Form submitted:', form)
    setForm({ name: '', phone: '', dob: '', birthTime: '', birthPlace: '' })
  }

  return (
    <div className="bg-yellow-50 p-8 md:p-16">
      <h2 className="text-3xl sm:text-4xl font-bold text-yellow-700 text-center mb-8">Missed Call? Leave Your Details</h2>
      <form 
